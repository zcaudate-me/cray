...
(defn get-settings []
  (array-map
    ...
    :viewpoint (make-vect 5.0 4.0 1.0)
    ; 	"Location that rays are cast from."
    :look-at (make-vect 0.0 1.0 1.0)
    ...
    :camera-up (normalize (make-vect 0.0 1.0 0.2))
    ...
    :ambient-light (make-colour 0.0 0.0 0.0)
